...
export const userProfiles = pgTable("user_profiles", {
  ...
  journalAccessEndsAt: timestamp("journal_access_ends_at"),
  journalAccessGrantedBy: varchar("journal_access_granted_by"),
...
export const journalEntries = pgTable("journal_entries", {
  ...
  secondarySignals: text("secondary_signals"),
  indicatorState: text("indicator_state"),
  liquidityTargets: text("liquidity_targets"),
  higherTFContext: text("higher_tf_context"),
  analysisTFContext: text("analysis_tf_context"),
  entryTFContext: text("entry_tf_context"),
  otherConfluences: text("other_confluences"),
