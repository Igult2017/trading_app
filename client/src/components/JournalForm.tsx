...
const StatRow = ({ label, value, valueColor }: any) => (
  <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"9px 0",borderBottom:"1px solid rgba(51,65,85,0.3)"}}>
    ...
    <span style={{fontSize:"11px",fontWeight:400,fontFamily:"'JetBrains Mono', monospace",fontVariantNumeric:"slashed-zero",color:valueColor||"#e2e8f0"}}>{value}</span>
  </div>
);
    ...
    <div style={{padding:"12px 16px 24px",display:"flex",flexDirection:"column",gap:"8px",width:"100%",boxSizing:"border-box"}}>
      <div style={{background:"rgba(10,13,20,0.8)",border:"1px solid rgba(51,65,85,0.5)",borderRadius:"12px",padding:"12px 14px"}}>
        ...
        <div style={{display:"flex",alignItems:"flex-end",justifyContent:"space-between"}}>
          <span style={{fontSize:"15px",fontWeight:400,fontFamily:"'JetBrains Mono', monospace",fontVariantNumeric:"slashed-zero",color:pnlColor}}>{stats?fmt(stats.netPnL):"0"}</span>
          <span style={{fontSize:"11px",fontWeight:400,fontFamily:"'JetBrains Mono', monospace",fontVariantNumeric:"slashed-zero",color:pnlColor}}>{stats?(stats.netPnL>=0?"+":"")+pnlPct+"%":"0%"}</span>
        </div>
      </div>
      <div style={{background:"rgba(10,13,20,0.6)",border:"1px solid rgba(51,65,85,0.4)",borderRadius:"12px",padding:"10px 14px"}}>
        ...
        <div style={{display:"flex",justifyContent:"space-between"}}>
          <span style={{fontSize:"12px",fontWeight:400,fontFamily:"'JetBrains Mono', monospace",fontVariantNumeric:"slashed-zero",color:"#cbd5e1"}}>{stats?fmt(stats.startBal):"$0.00"}</span>
          <span style={{fontSize:"12px",fontWeight:400,fontFamily:"'JetBrains Mono', monospace",fontVariantNumeric:"slashed-zero",color:"#cbd5e1"}}>{stats?fmt(stats.endBal):"$0.00"}</span>
        </div>
      </div>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",background:"rgba(10,13,20,0.6)",border:"1px solid rgba(51,65,85,0.4)",borderRadius:"12px",padding:"9px 14px"}}>
        ...
        <span style={{fontSize:"11px",fontWeight:400,fontFamily:"'JetBrains Mono', monospace",fontVariantNumeric:"slashed-zero",color:"#94a3b8"}}>{stats?fmt(stats.commissions):"$0.00"}</span>
      </div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:"5px"}}>
        {[
          ...
          <div key={label} style={{background:"rgba(10,13,20,0.6)",border:"1px solid rgba(51,65,85,0.4)",borderRadius:"10px",padding:"9px 4px",textAlign:"center"}}>
            ...
            <p style={{fontSize:"14px",fontWeight:400,fontFamily:"'JetBrains Mono', monospace",fontVariantNumeric:"slashed-zero",color}}>{val}</p>
          </div>
        ))}
      </div>
      <div style={{background:"rgba(10,13,20,0.6)",border:"1px solid rgba(51,65,85,0.4)",borderRadius:"12px",padding:"2px 14px"}}>
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"9px 0"}}>
          ...
          <span style={{fontSize:"11px",fontWeight:400,fontFamily:"'JetBrains Mono', monospace",fontVariantNumeric:"slashed-zero",color:stats&&stats.maxDD>0?"#f87171":"#94a3b8"}}>{stats?fmt(stats.maxDD):"$0.00"}</span>
        </div>
      </div>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:"5px"}}>
        {[
          ...
          <div key={label} style={{background:"rgba(10,13,20,0.6)",border:"1px solid rgba(51,65,85,0.4)",borderRadius:"10px",padding:"10px 4px",textAlign:"center"}}>
            ...
            <p style={{fontSize:"12px",fontWeight:400,fontFamily:"'JetBrains Mono', monospace",fontVariantNumeric:"slashed-zero",color}}>{val}</p>
          </div>
        ))}
      </div>
      {!trades.length&&(
            ...
            <div style={{background:"rgba(10,13,20,0.9)",border:"1px solid rgba(59,130,246,0.25)",borderRadius:"16px",padding:"14px 16px",height:"94px",boxSizing:"border-box",display:"flex",flexDirection:"column",justifyContent:"space-between",position:"relative",overflow:"hidden"}}>
              ...
              <div>
                <div style={{display:"flex",alignItems:"center",gap:"6px"}}>
                  ...
                  <span style={{fontSize:"17px",fontWeight:400,fontFamily:"'JetBrains Mono', monospace",fontVariantNumeric:"slashed-zero",color:"#e2e8f0",lineHeight:1}}>{trades.length}</span>
                </div>
