        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            >
              <Button 
                size="lg" 
                className="bg-black hover:bg-black/90 text-white px-8 py-6 text-lg rounded-full shadow-2xl"
          ...
          <div className="relative h-64 md:h-80 lg:h-96 flex items-end justify-center gap-2 md:gap-3 lg:gap-4">
            {bars.map((bar, index) => (
              <motion.div
                key={index}
