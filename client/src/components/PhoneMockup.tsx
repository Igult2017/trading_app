  ...
  return (
    <div style={{ position: 'relative', width: 210, userSelect: 'none' }}>
      ...
      >
        ...
        {/* ── App header ── */}
        <text x="26" y="80" fontFamily="Georgia,serif" fontSize="13" fontWeight="700" fill={d ? '#f1f5f9' : '#0f172a'}>Myfm</text>
        <text x="66" y="80" fontFamily="Georgia,serif" fontSize="13" fontWeight="700" fill={accent}>Journal</text>
        {/* Avatar circle */}
